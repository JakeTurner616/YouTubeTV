 ...
 *
 * When the renderer loads and a connection to YouTube's servers isn’t available,
 * this script will display a status message.
 */
...
styles.innerHTML = `
    ...
    * {
    ...
    /* Banner container: fixed to the center of the viewport */
    .connection_err {
        display: flex;
    ...
    /* Offline description styling: responsive width and max-width */
    .offline_description {
        font-size: 3vw;
        color: #525252;
        width: 90%;
...
// Append the style and the banner container to the document body.
...
// When the connection is restored, notify the main process.
